...
//echo index_page();
//require_once("application/views/admin/install_view.php"); 
//require_once("application/controllers/install.php");
?>
...
if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
        ...
        $sql = explode(";", file_get_contents('insert.sql')); //
...
(1, 'M', 0, 'Admin Home', '?section=admin-home', now(), 1)";
            ...
            $query_six = "INSERT INTO `content` (`id`, `category_id`, `user_id`, `image_id`, `date`, `title`, `url`, `body`, `meta_description`, `meta_keywords`, `visible`) VALUES
...
<input type="email" id="admin-email" maxlength="50" name="adminEmail" value="<?php
