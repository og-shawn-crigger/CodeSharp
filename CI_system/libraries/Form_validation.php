...
class CI_Form_validation {
    ...
    function set_rules($field, $label = '', $rules = '') {
        ...
        $this->_field_data[$field] = array('field' => $field, 'label' => $label, 'rules' =>
            $rules, 'is_array' => $is_array, 'keys' => $indexes, 'postdata' => null, 'error' =>
            '');
    }
    ...
    function encode_php_tags($str) {
        return str_replace(array('<?php', '<?PHP', '<?', '?>'), array('&lt;?php',
            '&lt;?PHP', '&lt;?', '?&gt;'), $str);
    }
